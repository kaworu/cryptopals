...
static MunitResult
test_ssrp_local_mitm_crack_fail(const MunitParameter *params, void *data)
{
	const char *password = srp_password;
...
MunitTest test_break_ssrp_suite_tests[] = {
	...
	{ "local/crack-fail", test_ssrp_local_mitm_crack_fail, srand_reset, NULL, MUNIT_TEST_OPTION_NONE, NULL },
